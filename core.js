...
core.math_font = 'MathJax_Math-italic';

core.svg.node = function (t) {
 return document.createElementNS('http://www.w3.org/2000/svg', t);
};

core.svg.group = function () {
 return this.node('g');
};

core.svg.line = function (x1, y1, x2, y2, color, thickness) {
...
core.svg.hline = function (x1, x2, y, color, thickness) {
 return this.line(x1, y, x2, y, color, thickness);
};

core.svg.vline = function (x, y1, y2, color, thickness) {
 return this.line(x, y1, x, y2, color, thickness);
};

core.svg.rect = function(x0,y0,w,h,color,thickness) {
...
core.svg.frect = function(x0,y0,w,h,color) {
 var n = this.node('rect');
 n.setAttribute('x', x0);
 n.setAttribute('y', y0);
 n.setAttribute('width', w);
...
core.svg.pane = function(x0,y0,w,h) {
 var n = this.node('rect');
 n.setAttribute('x', x0);
 n.setAttribute('y', y0);
 n.setAttribute('width', w);
...
core.svg.lines = function(points,color,thickness) {
...
core.svg.circle = function(x0,y0,r,color,thickness) {
...
core.svg.disc = function(x0,y0,r,color) {
 var n = this.node('circle');
 n.setAttribute('cx', x0);
 n.setAttribute('cy', y0);
 n.setAttribute('r', r);
...
core.svg.math_text = function(s,x,y) {
 var n = this.node('text');
 n.setAttribute('text-anchor','middle');
 n.setAttribute('alignment-baseline','middle');
 n.setAttribute('font-size','24px');
 n.setAttribute('font-family',core.math_font);
 n.setAttribute('fill','black');
 n.setAttribute('x', x);
 n.setAttribute('y', y);
 n.setAttribute('pointer-events','none');
...
core.svg.image = function(url,x,y,w,h) {
...
core.svg.append_tspan = function(t,s) {
...
core.svg.grid = function (rows, cols, x0, y0, w, h) {
 var g, i, j, x1, y1;
...
core.svg.shaded_grid = function(rows, cols, x0, y0, w, h, blocks) {
 var g,i,j,k;
...
core.svg.arrow_marker = function() {
...
core.demo.find_ids = function(ids) {
 var i,id,ids0,x;
...
core.demo.activate_youtube_button = function() {
 if (! this.name) { return; }
...
core.demo.get_offset = function( el ) {
 var _x = 0;
 var _y = 0;
